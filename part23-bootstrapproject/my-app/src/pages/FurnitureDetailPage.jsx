...
import banner4 from "../assets/img/banner/bannerfurnituredetail.jpg"
                    ...
                    <div className="row g-4">
                         ...
                         <div className="col-md-6">
                              ...
                              <div className="d-flex gap-2 mt-3">
                                   <button type="button" className="btn btn-dark " onClick={addToCardHandler} disabled={added}>{added ? "Added to Cart" : 'Add to Cart'}</button>

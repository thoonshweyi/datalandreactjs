...
const Contact = ()=>{
     ...
     return (
         ...
         {/* Start Contact Section */}
          <section id="contact" className="p-5 contacts">
               <div className="container-fluid">

                    <div className="col-lg-5">
                         <h5 className="display-4 text-white mb-3">Get New Letter</h5>

                         <form onSubmit={submitHandler} className="" action="" method="">
                         ...
                         <div className="form-group py-4">
                              <input type="email" name="email" id="email" className="form-control p-3 inputs" placeholder="Enter Your Email" autoComplete="off" alue={formData.email} onChange={changeHandler} required/>
